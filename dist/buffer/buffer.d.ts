...
import { ShaderDefines } from '../shader/shader-utils.js';
...
declare class Buffer {
    ...
    _getMesh(materialName: BufferMaterials): Mesh | LineSegments | Points;
    getMesh(): Mesh | LineSegments | Points;
    getWireframeMesh(): LineSegments;
    getPickingMesh(): Mesh | LineSegments | Points;
